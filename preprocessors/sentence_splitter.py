...
# Source: https://github.com/mediacloud/sentence-splitter
...
class SentenceSplitter(object):
    ...
    def __init__(self, language: str, non_breaking_prefix_file: str = None):
        ...
        if non_breaking_prefix_file is None:
            non_breaking_prefix_file = files("src") / "resources" / "hu.txt"
    ...
    def split(self, text: str) -> List[str]:
        ...
        text = regex.sub(
            pattern=(r'([?!\.][\ ]*[\'")\]\p{Final_Punctuation}]+) +([\'"([\u00bf\u00A1\p{Initial_Punctuation}]*[\ ]*'
            ...
            if match:
                ...
                if is_prefix_honorific(prefix_=prefix, starting_punct_=starting_punct):
                    ...
                    pass
                        ...
                        pattern=(r'^([ ]*[\'"([\u00bf\u00A1\p{Initial_Punctuation}]*[ ]*[\p{Uppercase_Letter}'
